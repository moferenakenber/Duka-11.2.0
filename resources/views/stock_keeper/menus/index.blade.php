  ...
  <div class="bg-gray-100 min-h-screen">
    <div class="container mx-auto p-4">
      ...
      <div class="grid grid-cols-2 gap-4 mt-4">
        ...
        <a href="#" class="flex items-center p-4 rounded-lg bg-white hover:bg-gray-100">
          <svg
            ...
            class="w-6 h-6 mr-2"
          >
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-10a1 1 0 00-1-1H7a1 1 0 00-1 1v10h5" />
          </svg>
      ...
      <form
        action="{{ route('logout') }}"
        method="POST"
        class="block px-4 pt-72 pb-16 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
        role="menuitem"
      >
        @csrf
        <button type="submit" class="w-full text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-md">
          Sign out
        </button>
      </form>
    </div>
