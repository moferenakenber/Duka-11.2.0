<div class="btm-nav">
    ...
    <!-- Orders Button -->
    <a href="/stockkeeper/orders"
        class="border-blue-600 text-blue-600 flex flex-col items-center
    {{ request()->is('stockkeeper/orders') ? 'bg-blue-200 active' : '' }}">
    ...
    <!-- Inventory Button -->
    <a href="stockkeeper/inventory"
        class="border-blue-600 text-teal-600 flex flex-col items-center
    {{ request()->is('stockkeeper/inventory') ? 'bg-teal-200 active' : '' }}">
