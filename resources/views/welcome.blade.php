...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="min-h-screen flex flex-col">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
      ...
      >
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl flex flex-col items-center justify-center">
          <header class="flex items-center justify-center w-full h-screen">
            <h2
              class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
            >
              Welcome to Mezgebedirjit
            </h2>
          </header>

          <!-- Centered Main Content -->
          <main class="flex-1 flex items-center justify-center w-full h-screen">
            <!-- Insert your main content here -->
            <div class="flex justify-center items-center gap-2 py-10">
              @if (Route::has('login'))
