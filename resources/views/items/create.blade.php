    ...
    <div class="max-w-4xl mx-auto p-4 bg-white rounded-lg shadow-md">
        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="w-full p-2 border border-gray-300 rounded-md mt-1">
            </div>
            <div class="mb-4">
                <label for="description" class="block text-gray-600">Product Description</label>
                <textarea rows="5" name="description" placeholder="Enter product description" class="w-full p-2 border border-gray-300 rounded-md mt-1"></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" min="0" class="w-full p-2 border border-gray-300 rounded-md mt-1">
            </div>
