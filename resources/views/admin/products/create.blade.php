...
@section('content')
  ...
  <form action="{{ route('product.store') }}" method="POST">
    ...
    <input type="text" name="metaTitle" id="metaTitle" required />
    <br />
    <br />
    ...
    <input type="text" name="updatedAt" id="updatedAt" required />
    <br />
    <br />
    <label for="publishedAt">PublishedAt</label>
    <input type="text" name="publishedAt" id="publishedAt" required />
    <br />
    <br />
    <label for="startsAt">StartsAt</label>
    <input type="text" name="startsAt" id="startsAt" required />
    <br />
    <br />
    <label for="endsAt">EndsAt</label>
    <input type="text" name="endsAt" id="endsAt" required />
    <br />
    <br />
