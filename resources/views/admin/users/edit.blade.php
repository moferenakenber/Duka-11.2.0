<x-app-layout>
    ...
    <form class="max-w-sm mx-auto" action="{{ route('admin.users.update', $user) }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <input type="text" id="phone-input" name="phone_number"
                    value="{{ old('phone_number', $user->phone_number) }}" aria-describedby="helper-text-explanation"
        ...
        <div class="mb-6">
            ...
            <select id="countries" name="role" required
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option {{ old('role', $user->role) == 'Stock Keeper' ? 'selected' : '' }} value="stock_keeper">Stock Keeper</option>
