  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-end h-16">
      ...
      {{--
        ...
        <x-nav-link :href="route('admin.customers.index')" :active="request()->routeIs('customers.index')">
        {{ __('Customers') }}
        </x-nav-link>
        </div>
        </div>
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    ...
    <div class="pt-2 pb-3 space-y-1">
      <x-responsive-nav-link
        ...
        :active="request()->routeIs('user_management.index')"
      >
        {{ __('User Management') }}
      </x-responsive-nav-link>
    </div>
    ...
    <div class="pt-2 pb-3 space-y-1">
      <x-responsive-nav-link :href="route('admin.customers.index')" :active="request()->routeIs('customers.index')">
        {{ __('Customers') }}
      </x-responsive-nav-link>
    </div>
