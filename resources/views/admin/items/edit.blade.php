...
{{ old('description', $item->description) }}</textarea
      ...
      <div class="mb-4">
        ...
        <select name="status" class="w-full p-2 border border-gray-300 rounded-md mt-1">
          ...
          <option value="Not Available" {{ old('status', $item->status) == 'Not Available' ? 'selected' : '' }}>
            Not Available
          </option>
        </select>
      </div>
      ...
      <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:gap-4">
        ...
        <input
          type="number"
          name="piecesinapacket"
          value="{{ old('piecesinapacket', $item->piecesinapacket) }}"
          min="0"
          max="1000"
      ...
      <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:gap-4">
        ...
        <input
          type="number"
          name="packetsinacartoon"
          value="{{ old('packetsinacartoon', $item->packetsinacartoon) }}"
          min="0"
          max="1000"
          class="w-full sm:w-1/2 p-2 border border-gray-300 rounded-md mt-1"
        />
      ...
      <div class="mb-4">
        ...
        <input
          class="form-control w-full p-2 border border-gray-300 rounded-md mt-1"
          type="file"
          name="images[]"
          id="formFileMultiple"
          multiple
