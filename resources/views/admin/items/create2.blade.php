      ...
      <div x-show="step === 1">
        ...
        <div class="flex flex-wrap space-x-4 mb-4">
          <div class="flex items-center">
            ...
            />
            <label for="office-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Office
            </label>
          </div>
          ...
          <div class="flex items-center">
            <input
              ...
              class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label for="school-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              School
            </label>
          </div>
          ...
          <div class="flex items-center">
            <input
              ...
              class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label for="government-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
              Government
            </label>
          </div>
        </div>

        <button type="button" @click.prevent="step = 2" class="btn btn-primary mt-4">Next</button>
      </div>
      ...
      <div x-show="step === 2">
        <div x-data="packagingForm()" class="mt-4 space-y-4">
          ...
          <div class="flex items-center space-x-4">
            <div class="flex-1">
              <label for="package-name-1" class="block text-sm font-medium text-gray-900 dark:text-white">
                Packaging Name
              </label>
              <input
                x-model="firstPackagingName"
                type="text"
                id="package-name-1"
                placeholder="Packet"
            ...
            <div class="flex-1">
              <label for="package-name-2" class="block text-sm font-medium text-gray-900 dark:text-white">
                Packaging Name
              </label>
              <input
                x-model="secondPackagingName"
                type="text"
                id="package-name-2"
                placeholder="Pieces"
                class="mt-1 block w-full p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <template x-for="(item, index) in packagingList" :key="index">
            <div class="flex items-center space-x-4">
              <div class="flex-1">
                <label
                  :for="'package-name-' + (index + 3)"
                  class="block text-sm font-medium text-gray-900 dark:text-white"
                >
                  Packaging Name
                </label>
                <input
                  :id="'package-name-' + (index + 3)"
                  type="text"
                  :placeholder="'Cartoon'"
                  class="mt-1 block w-full p-2.5 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
              ...
              <div class="w-20">
                <input
                  x-model.number="item.holds"
                  type="number"
                  :id="'holds-number-' + (index + 3)"
                  placeholder="Number"
                  class="mt-1 block w-full p-2 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
              </div>
          ...
          <div x-show="firstHolds && packagingList.length > 0" class="mt-4">
            <div class="text-sm font-medium text-gray-900 dark:text-white">
              <span>Result:</span>
              <span x-text="calculateTotalHolds()"></span>
              pieces
            </div>
          </div>
          ...
          <div class="mt-6 text-center">
            <button @click="addPackaging" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
              Add Packaging
            </button>
          </div>
        </div>
