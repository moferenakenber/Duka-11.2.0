    ...
    <div class="py-12">
        <div x-data="{ open: false }" class="max-w-7xl mx-auto sm:px-6 lg:px-8 min-h-screen overflow-y-auto px-4">
            <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <button x-show="open" id="dropdownBgHoverButton" data-dropdown-toggle="dropdownBgHover"
                ...
                <div id="dropdownBgHover" class="z-10 hidden w-48 bg-white rounded-lg shadow dark:bg-gray-700">
                    <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="checkbox-crate" type="checkbox" value="Crate"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                <label for="checkbox-crate"
                                    class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Crate</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="checkbox-doz" type="checkbox" value="Doz"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                <label for="checkbox-doz"
                                    class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Doz</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="checkbox-packet" type="checkbox" value="Packet"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                <label for="checkbox-packet"
                                    class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Packet</label>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                <input id="checkbox-wrapper" type="checkbox" value="Wrapper"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                <label for="checkbox-wrapper"
                ...
                <form x-show="open" class="max-w-xs mx-auto">
                    <label for="bedrooms-input"
                        class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
                    <div class="relative flex items-center max-w-[11rem]">
                        ...
                        <input type="text" id="bedrooms-input" data-input-counter data-input-counter-min="1"
                            data-input-counter-max="5000" aria-describedby="helper-text-explanation"
