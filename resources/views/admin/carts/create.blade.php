        ...
        <div class="p-6">
          <form action="{{ route('admin.carts.store') }}" method="POST">
            ...
            <div class="mb-4">
              ...
              <select name="seller_id" id="seller_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <!-- Submit Button -->
            <div class="mt-4">
              <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md">
                Create Cart
              </button>
            </div>
          </form>
