        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">We Didn't Just Create a System</h2>
                    <p class="mb-4">We are experts in inventory management, sales tracking, and seamless POS solutions. Problem solvers driven by innovation. Agile enough to adapt to your business needs quickly, yet robust enough to deliver comprehensive solutions at scale.</p>
                    <p>Our mission is to empower businesses with tools that simplify operations and drive growth efficiently.</p>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for business teams like yours, Mezgebe Dirijit focuses on empowering companies with innovative technology and POS solutions to manage their inventory, sales, and staff more efficiently. By leveraging cutting-edge tools, we help businesses unlock long-term value, drive operational growth, and enhance overall performance.</p>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Plan, manage, and optimize your sales strategies. Seamlessly collaborate across teams to boost your sales performance and achieve monthly revenue targets with our all-in-one system.</p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Simplify your processes, manage your sales and inventory seamlessly, and stay efficient with our tailored workflows and real-time tracking tools.</p>
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Streamline your operations by automating inventory tracking, sales reports, and customer notifications. Get started with powerful templates designed to simplify your workflows and save time.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <div id="accordion-collapse" data-accordion="collapse">
            ...
            <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
              <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <p class="mb-2 text-gray-500 dark:text-gray-400">Mezgebe Dirijit is a comprehensive solution for businesses, offering tools to streamline inventory management, track sales, and enhance POS functionality with ease.</p>
                <p class="text-gray-500 dark:text-gray-400">Discover how to <a href="/docs/getting-started/introduction/" class="text-blue-600 dark:text-blue-500 hover:underline">get started</a> and simplify your business operations with our intuitive and powerful tools.</p>
              </div>
            </div>
            ...
            <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
              <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                <p class="mb-2 text-gray-500 dark:text-gray-400">Mezgebe Dirijit is designed with a focus on simplicity and efficiency, ensuring businesses can easily manage inventory, sales, and POS operations from a single platform.</p>
                <p class="text-gray-500 dark:text-gray-400">Learn more about our intuitive tools and how they can help streamline your business by exploring the <a href="/design-system" class="text-blue-600 dark:text-blue-500 hover:underline">design system</a> powered by Tailwind CSS and our advanced components.</p>
              </div>
            </div>
            <h2 id="accordion-collapse-heading-3">
              <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
                <span>What are the differences between a regularly managed company and a company that uses Mezgebe Dirijit?</span>
                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                </svg>
              </button>
            ...
            <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
              <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                <p class="mb-2 text-gray-500 dark:text-gray-400">The key difference lies in efficiency and control. Regularly managed companies often rely on manual processes, which can lead to inefficiencies, errors, and lack of real-time insights. In contrast, companies using Mezgebe Dirijit benefit from automated inventory tracking, seamless sales management, and comprehensive reporting tools that empower smarter decision-making.</p>
                <p class="mb-2 text-gray-500 dark:text-gray-400">With Mezgebe Dirijit, businesses streamline their operations, reduce errors, and improve overall productivity by leveraging our intuitive platform tailored for modern business needs.</p>
                <p class="mb-2 text-gray-500 dark:text-gray-400">Discover how Mezgebe Dirijit can transform your business:</p>
                <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                  <li><a href="/features" class="text-blue-600 dark:text-blue-500 hover:underline">Explore Our Features</a></li>
                  <li><a href="/case-studies" class="text-blue-600 dark:text-blue-500 hover:underline">Success Stories</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                        <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Mezgebe Dirijit is out! See what's new</span>
                        <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                    </a>
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">We help keep your campany run smoothly</h1>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at Mezgebe Dirijit, we focus on helping businesses streamline their inventory, sales, and staff management through advanced point-of-sale (POS) systems. By leveraging technology and innovation, we empower companies to efficiently manage their operations, optimize their processes, and unlock long-term growth and success.</p>
    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl">
                ...
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium flex space-x-4 rtl:space-x-reverse">
                        <li>
                            <a href="#" class="hover:underline">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path d="M12 2.043c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10zm-1.6 14h-2.4v-6h2.4v6zm-1.2-7.2c-.8 0-1.2-.8-1.2-1.2s.4-1.2 1.2-1.2 1.2.4 1.2 1.2-.4 1.2-1.2 1.2zM12 4.5c-3.8 0-6.9 3.1-6.9 6.9h1.9c0-2.7 2.2-4.9 4.9-4.9 2.7 0 4.9 2.2 4.9 4.9h1.9c0-3.8-3.1-6.9-6.9-6.9z"/>
                                </svg>
                        ...
                        <li>
                            <a href="#" class="hover:underline">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path d="M19 3h-2c-1.1 0-2 .9-2 2v2h-2v3h2v7h3v-7h2.9l.1-3h-3v-2c0-.6.5-1 1-1h2v-3h-2c-2.2 0-4 1.8-4 4v2h-2v3h2v7h3v-7h2v-3h-2v-2c0-2.2 1.8-4 4-4h2v3h-2c-.6 0-1 .4-1 1v2h3.1l.1 3h-3v7h3v-7h2v-3h-2v-2c0-3.3-2.7-6-6-6z"/>
                                </svg>
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center ml-4 rtl:ml-0" id="timestamp"></span>
            </div>
        </div>
    </footer>
