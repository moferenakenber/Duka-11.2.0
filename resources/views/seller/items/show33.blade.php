...
<div class="max-w-md mx-auto p-4"
     x-data="variantSelector({{ $item->variants->map(fn($v) => [
    ...
    <!-- Image Preview -->
    <div class="mb-4">
        <img :src="selectedColor ? selectedColor.img : '/img/product.jpg'" alt="Selected Color Image" class="w-64 h-64 rounded border object-cover mx-auto" />
    </div>
    ...
    <!-- Add to Cart Button -->
    <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" @click="alert(`Added ${selectedColor.name} variant to cart! Price: $${formattedPrice}`)">
        Add to Cart
    </button>
</div>
