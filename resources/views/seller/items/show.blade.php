                ...
                <div class="overflow-hidden bg-white rounded-lg shadow-lg">
                    ...
                    <div x-data="{
                        ...
                        init() {
                            if(this.variants.length > 0) {
                                const first = this.variants[0];
                                this.selectedColor = { name: first.color, img: first.images?.[0] || first.img || '/img/default.jpg', disabled: first.disabled };
                                this.selectedSize = first.size;
                        ...
                        get previewImage() {
                            return this.selectedVariant?.images?.[0] || this.selectedColor?.img || '/img/product.jpg';
                        },
                        ...
                        <div class="mb-4"
                            ...
                            <button :disabled="!selectedColor || !selectedSize"
                                ...
                                :class="(!selectedColor || !selectedSize) ? 'bg-gray-400 cursor-not-allowed' :
