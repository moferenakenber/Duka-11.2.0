...
@section('content')
  {{--
    ...
    <div
    class="p-2 text-gray-900 bg-gray-100 {{-- dark:text-gray-100
  --}}
  {{-- bg-white --}}
  {{--
    dark:bg-gray-800   shadow-sm sm:rounded-lg overflow-y-auto mx-auto max-w-2xl w-full rounded-lg border-b border-gray-400/50">
  ...
  <div class="bg-gray-100 min-h-screen">
    <div class="container mx-auto p-2.5">
      ...
      <div class="flex flex-col h-full pb-16 pt-1 justify-center items-center">
        ...
        <div class="bg-white dark:bg-gray-800 flex-1 overflow-y-auto mx-auto w-full max-w-2xl m rounded-lg shadow-lg">
          <div class="p-2 text-gray-900 dark:text-gray-100 rounded-lg shadow-lg overflow-y-auto">
            <form class="max-w-sm mx-auto" action="{{ route('admin.customers.store') }}" method="POST">
              ...
              <div class="mb-4">
                <button
                  type="submit"
                  class="w-full bg-indigo-600 text-white p-3 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-500"
                >
                  Submit
                </button>
              </div>
