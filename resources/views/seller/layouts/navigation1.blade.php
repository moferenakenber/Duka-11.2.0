<div class="btm-nav">
  ...
  <a
    ...
    class="border-blue-600 text-blue-600 flex flex-col items-center {{ request()->is('seller/dashboard') ? 'bg-blue-200 active' : '' }}"
  >
  ...
  <a
    ...
    class="border-blue-600 text-blue-600 flex flex-col items-center {{ request()->is('seller/customers') ? 'bg-blue-200 active' : '' }}"
  >
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        stroke-linecap="round"
  ...
  <a
    href="/seller/carts"
    class="border-blue-600 text-teal-600 flex flex-col items-center {{ request()->is('seller/carts') ? 'bg-teal-200 active' : '' }}"
  >
