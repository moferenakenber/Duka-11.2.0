...
////////////////////////////////////////////////////////////////////////
        ...
        $noteitSize = ItemSize::where('name', '3x3')->first();
        $noteitSize2 = ItemSize::where('name', '4x4')->first();
        $noteitSize3 = ItemSize::where('name', '5x5')->first();
        ...
        $variationsPerItem = [
            ...
            [
                ...
                // Yellow 3*3 - Piece, Packet, Cartoon
                [
                ...
                [
                 ...
                 // Yellow 4*4 - Piece, Packet, Cartoon
                [
                    'color' => $colorYellow->id,
                    'size' => $noteitSize2->id,
                    'packaging' => $piecePackaging->id,
                ...
                [
                  ...
                  // Yellow 5*5 - Piece, Packet, Cartoon
                [
                    'color' => $colorYellow->id,
                    'size' => $noteitSize3->id,
                    'packaging' => $piecePackaging->id,
